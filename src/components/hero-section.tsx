...
const HeroSection = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    ...
    alt="hero" src="https://is1-ssl.mzstatic.com/image/thumb/Purple123/v4/2d/35/9b/2d359b56-ea0e-7909-5a89-9998d8571566/pr_source.jpg/392x696bb.jpg"></img>
    <div className="text-center lg:w-2/3 w-full">
      ...
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Talk to Companion</button>
